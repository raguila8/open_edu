...
ActiveRecord::Schema.define(version: 2020_09_21_201212) do
  ...
  create_table "resources_tags", force: :cascade do |t|
    ...
    t.string "resources_type", null: false
    t.bigint "resources_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["resources_type", "resources_id"], name: "index_resources_tags_on_resources_type_and_resources_id"
  ...
  add_foreign_key "resources_tags", "tags"
end
